...
namespace KangHui.BaseClass
{
    ...
    public class PageBaseAccess
    {
        ...
        /// <returns></returns>
        public static DataSet GetDataSource(int PageIndex, int PageSize, string selectFields, string tableNames, string strWhere, string orderField, OrderTypes orderType, ref int rows, string connectionString)
        {
            OleDbParameter[] parameters = {
					new OleDbParameter("@tblName", OleDbType.VarChar, 1000),
                    new OleDbParameter("@strGetFields", OleDbType.VarChar, 1000),
					new OleDbParameter("@fldName", OleDbType.VarChar, 255),
					new OleDbParameter("@PageSize", OleDbType.Integer),
					new OleDbParameter("@PageIndex", OleDbType.Integer),
					new OleDbParameter("@OrderType", OleDbType.Binary),
					new OleDbParameter("@strWhere", OleDbType.VarChar,1500),
                    new OleDbParameter("@Counts", OleDbType.Integer)
					};
            ...
            DataSet ds = DbHelpAccess.RunProcedure("p_GetRecordByPageOrder", parameters, "ds", connectionString);
        ...
        /// <param name="OrderTypes">排序类型</param>
        /// <param name="connectionString">数据库连接字符串</param>
        public static void BindData(GridView gv, AspNetPager pager, string selectFields, string tableNames, string strWhere, string orderField, OrderTypes orderType, string connectionString)
        {
            int rows = 0;
        ...
        /// <param name="OrderTypes">排序类型</param>
        /// <param name="connectionString">数据库连接字符串</param>
        public static void BindData(DataList dl, AspNetPager pager, string selectFields, string tableNames, string strWhere, string orderField, OrderTypes orderType, string connectionString)
        {
            int rows = 0;
            DataSet ds = GetDataSource(pager.CurrentPageIndex, pager.PageSize, selectFields, tableNames, strWhere, orderField, orderType, ref rows, connectionString);
            pager.RecordCount = rows;
        ...
        /// <param name="OrderTypes">排序类型</param>
        /// <param name="connectionString">数据库连接字符串</param>
        public static void BindData(Repeater rp, AspNetPager pager, string selectFields, string tableNames, string strWhere, string orderField, OrderTypes orderType, string connectionString)
        {
            int rows = 0;
            DataSet ds = GetDataSource(pager.CurrentPageIndex, pager.PageSize, selectFields, tableNames, strWhere, orderField, orderType, ref rows, connectionString);
            pager.RecordCount = rows;
        ...
        public static DataSet GetDataSourceWithNotInProc(int pageIndex, int pageSize, string selectFields, string tableNames, string strWhere, string groupField, string orderField, string pkField, ref int rows, string connectionString)
        {
            OleDbParameter[] parameters = {
					new OleDbParameter("@tblName", OleDbType.VarChar, 1000),
                    new OleDbParameter("@strGetFields", OleDbType.VarChar, 1000),
					new OleDbParameter("@keyCol", OleDbType.VarChar, 100),
                    new OleDbParameter("@strWhere", OleDbType.VarChar,8000),
                    new OleDbParameter("@strGroupBy", OleDbType.VarChar,1000),
                    new OleDbParameter("@strOrder", OleDbType.VarChar,1000),
					new OleDbParameter("@PageSize", OleDbType.Integer),
					new OleDbParameter("@PageIndex", OleDbType.Integer),
                    new OleDbParameter("@Counts", OleDbType.Integer)
					};
            ...
            DataSet ds = DbHelpAccess.RunProcedure("p_GetPageData_NotIn", parameters, "ds", connectionString);
        ...
        public static int GetRecordCount(string _sql, string connString)
        {
            ...
            object obj = DbHelpAccess.GetSingle(_sql, connString);
