...
{
    public class VideoConvertHelper : System.Web.UI.Page
    {
        public VideoConvertHelper()
        { }
        ...
        {
            string ffmpeg = Server.MapPath(VideoConvertHelper.ffmpegtool);
            if ((!System.IO.File.Exists(ffmpeg)) || (!System.IO.File.Exists(fileName)))
            {
                return "";
            }
            string flv_file = System.IO.Path.ChangeExtension(playFile, ".flv");
            string FlvImgSize = VideoConvertHelper.sizeOfImg;
        ...
        {
            string tool = Server.MapPath(VideoConvertHelper.mencodertool);
