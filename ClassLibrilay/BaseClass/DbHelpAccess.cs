...
namespace KangHui.BaseClass
{
    public class DbHelpAccess
    {
        ...
        public static int GetMaxID(string FieldName, string TableName, string connectionString)
        {
            ...
            object obj = DbHelpAccess.GetSingle(strsql, connectionString);
            if (obj == null)
            {
                return 1;
            }
        ...
        public static bool Exists(string strSql, string connectionString, params OleDbParameter[] cmdParms)
        {
            object obj = DbHelpAccess.GetSingle(strSql, connectionString, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        /// <summary>
        /// 执行查询语句，返回OleDbDataReader ( 注意：使用后一定要对OleDbDataReader进行Close )
        /// </summary>
        ...
        /// <param name="SQLString">SQL语句</param>
        /// <returns>影响的记录数</returns>
        public static int ExecuteSql(string SQLString, string connectionString, params OleDbParameter[] cmdParms)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
        ...
        public static int ExecuteSql(string SQLString, OleDbConnection connection, OleDbTransaction trans, params OleDbParameter[] cmdParms)
        {
            using (OleDbCommand cmd = new OleDbCommand())
            {
                try
        ...
        public static object GetSingle(string SQLString, OleDbConnection connection, OleDbTransaction trans, params OleDbParameter[] cmdParms)
        {
            using (OleDbCommand cmd = new OleDbCommand())
            {
                try
        ...
        /// <param name="strSQL">查询语句</param>
        /// <returns>OleDbDataReader</returns>
        public static OleDbDataReader ExecuteReader(string SQLString, string connectionString, params OleDbParameter[] cmdParms)
        {
            OleDbConnection connection = new OleDbConnection(connectionString);
            OleDbCommand cmd = new OleDbCommand();
            try
        ...
        /// <param name="SQLString">查询语句</param>
        /// <returns>DataSet</returns>
        public static DataSet Query(string SQLString, string connectionString, params OleDbParameter[] cmdParms)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
                OleDbCommand cmd = new OleDbCommand();
        ...
        /// <summary>
        /// 执行存储过程 ( 注意：使用后一定要对OleDbDataReader进行Close )
        /// </summary>
        /// <param name="storedProcName">存储过程名</param>
        /// <param name="parameters">存储过程参数</param>
        /// <returns>OleDbDataReader</returns>
        public static OleDbDataReader RunProcedure(string storedProcName, string connectionString, IDataParameter[] parameters)
        {
            using (OleDbConnection connection = new OleDbConnection(connectionString))
            {
