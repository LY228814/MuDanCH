...
namespace KangHui.JianHui.Utils.Common
{
    ...
    public class ScriptHelper
    {
        ...
        #region 控件点击消息确认提示框，并关闭窗体的方法
        /// <summary>
        /// 控件点击消息确认提示框，并关闭窗体的方法
        /// </summary>
        /// <param name="Control">点击控件的对象</param>
        /// <param name="msg">提示信息</param>
        ...
        #region 显示消息确认提示框，并关闭窗体，刷新父窗体的方法
        /// <summary>
        /// 显示消息确认提示框，并关闭窗体，刷新父窗体的方法
        /// </summary>
        /// <param name="page">当前页面指针，一般为this</param>
        /// <param name="msg">提示信息</param>
        ...
        #region 点击控件消息确认提示框，并关闭窗体，刷新父窗体的方法
        /// <summary>
        /// 点击控件消息确认提示框，并关闭窗体，刷新父窗体的方法
        /// </summary>
        /// <param name="Control">点击控件的对象</param>
        /// <param name="msg">提示信息</param>
        /// <param name="url">父窗体地址</param>
        ...
        #region 显示消息提示对话框，并进行页面跳转的方法
        /// <summary>
        /// 显示消息提示对话框，并在当前页面进行跳转的方法
        /// </summary>
        /// <param name="page">当前页面指针，一般为this</param>
        /// <param name="msg">提示信息</param>
        ...
        #region 显示消息提示对话框，并在最上层页面进行跳转的方法
        /// <summary>
        /// 显示消息提示对话框，并在最上层页面进行跳转的方法
        /// </summary>
        /// <param name="page">当前页面指针，一般为this</param>
        /// <param name="msg">提示信息</param>
        /// <param name="url">跳转的目标地址</param>
