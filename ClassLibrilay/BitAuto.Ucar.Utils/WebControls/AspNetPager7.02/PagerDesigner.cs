...
namespace BitAuto.Ucar.Utils.WebControls
{
    ...
    public class AspNetPagerActionList : DesignerActionList
    {
        ...
        public override DesignerActionItemCollection GetSortedActionItems()
        {
            ...
            actionItems.Add(new DesignerActionHeaderItem("分页方式"));
            ...
            actionItems.Add(new DesignerActionPropertyItem("CenterCurrentPageButton", "居中显示当前页数字索引按钮", "外观"));
        ...
        public bool CenterCurrentPageButton
        {
            get
            {
                return pager.CenterCurrentPageButton;
            }
            set
            {
                SetProperty("CenterCurrentPageButton", value);
            }
        }
