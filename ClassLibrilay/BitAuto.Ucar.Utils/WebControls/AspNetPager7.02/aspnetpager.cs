...
namespace BitAuto.Ucar.Utils.WebControls
{
    ...
    public class AspNetPager : Panel, INamingContainer, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        /// <include file='AspNetPagerDocs.xml' path='AspNetPagerDoc/Property[@name="ShowLastNumericButton"]/*'/>
        [Browsable(true), Themeable(false), ANPCategory("cat_Navigation"), ANPDescription("desc_ShowLastNumericButton"), DefaultValue(true)]
        public bool ShowLastNumericButton
        {
            get
            {
                if (null != cloneFrom)
                    return cloneFrom.ShowLastNumericButton;
                object obj = ViewState["ShowLastNumericButton"];
                return (obj == null) ? true : (bool)obj;
            }
            set
            {
                ViewState["ShowLastNumericButton"] = value;
            }
        }
        ...
        [Obsolete("该属性已废弃，请使用 ShowPageIndexBox 属性"), Browsable(false), Themeable(false), ANPDescription("desc_ShowInputBox"), ANPCategory("cat_PageIndexBox"), DefaultValue(ShowInputBox.Auto)]
        ...
        [Obsolete("该属性已废弃，请使用 PageIndexBoxClass 属性"), Browsable(false), ANPCategory("cat_PageIndexBox"), DefaultValue(null), ANPDescription("desc_InputBoxClass")]
        ...
        [Obsolete("该属性已废弃，请使用 PageIndexBoxStyle 属性"),Browsable(false), ANPCategory("cat_PageIndexBox"), DefaultValue(null), ANPDescription("desc_InputBoxStyle")]
        ...
        [Obsolete("该属性已废弃，请使用 TextBeforePageIndexBox 属性"),Browsable(false), Themeable(false), ANPCategory("cat_PageIndexBox"), DefaultValue(null), ANPDescription("desc_TextBeforeInputBox")]
        ...
        [Obsolete("该属性已废弃，请使用 TextAfterPageIndexBox 属性"), Browsable(false), Themeable(false), DefaultValue(null), ANPCategory("cat_PageIndexBox"), ANPDescription("desc_TextAfterInputBox")]
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (null != CloneFrom && string.Empty != CloneFrom.Trim())
            {
                ...
                if (null == ctrl)
                {
                    ...
                    if (null == errStr)
                        errStr = "The control \" %controlID% \" does not exist or is not of type BitAuto.Ucar.Utils.WebControls.AspNetPager!";
        ...
        public override void RenderBeginTag(HtmlTextWriter writer)
        {
            ...
            writer.WriteLine();
            writer.Write("<!-- ");
            writer.Write("AspNetPager V" + ver + " for VS2005 & VS2008  Copyright:2003-2007 Webdiyer (www.webdiyer.com)");
            writer.WriteLine(" -->");
            if (!showPager)
            {
                writer.Write("<!--");
        ...
        protected override void RenderContents(HtmlTextWriter writer)
        {
            ...
            if (ShowPageIndex)
            {
                ...
                if (PageCount > NumericButtonCount && endIndex < PageCount)
                {
                    ...
                    if (ShowLastNumericButton)
                        CreateNumericButton(writer, PageCount);
                }
            }
            else
            {
                if (ShowCustomInfoSection == ShowCustomInfoSection.BetweenPreviewNext)
                {
