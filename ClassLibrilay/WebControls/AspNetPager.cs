...
namespace KangHui.WebControls
{
    ...
    public class AspNetPager : Panel, INamingContainer, IPostBackEventHandler, IPostBackDataHandler
    {
        ...
        [Browsable(true), Themeable(false), ANPDescription("desc_FirstPageText"), ANPCategory("cat_Navigation"), DefaultValue("&lt;&lt;")]
        ...
        [Browsable(true), Themeable(false), ANPDescription("desc_PrevPageText"), ANPCategory("cat_Navigation"), DefaultValue("&lt;")]
        ...
        [Browsable(true), Themeable(false), ANPDescription("desc_NextPageText"), ANPCategory("cat_Navigation"), DefaultValue("&gt;")]
        ...
        [Browsable(true), Themeable(false), ANPDescription("desc_LastPageText"), ANPCategory("cat_Navigation"), DefaultValue("&gt;&gt;")]
        ...
        public HorizontalAlign CustomInfoTextAlign
        {
            get
            {
                ...
                return (null == obj) ? HorizontalAlign.Left : (HorizontalAlign)obj;
            }
            set
            {
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            if (null != CloneFrom && string.Empty != CloneFrom.Trim())
            {
                ...
                if (null == ctrl)
                {
                    ...
                    if (null == errStr)
                        errStr = "The control \" %controlID% \" does not exist or is not of type KangHui.WebControls.AspNetPager!";
        ...
        public override void RenderBeginTag(HtmlTextWriter writer)
        {
            ...
            writer.WriteLine();
            writer.Write("<!-- ");
            writer.Write("AspNetPager V" + ver + " for VS2005  Copyright:2007 BitAuto,All Rights Reserved.");
            writer.WriteLine(" -->");
            if (!showPager)
            {
                writer.Write("<!--");
	...
	public class PagerDesigner:System.Web.UI.Design.ControlDesigner
	{
		...
		{
			string errorstr="Error creating control£º"+e.Message;
    ...
    internal sealed class SR
    {
        private SR()
        {
            _rm = new System.Resources.ResourceManager("KangHui.WebControls.AspNetPager",base.GetType().Assembly);
        }
