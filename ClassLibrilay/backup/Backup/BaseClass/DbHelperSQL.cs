...
namespace Ucar.BaseClass
{
    ...
    public class DbHelperSQL
    {
        ...
        public static int GetMaxID(string FieldName, string TableName, string connectionString)
        {
            ...
            object obj = DbHelperSQL.GetSingle(strsql, connectionString);
            if (obj == null)
            {
                return 1;
            }
        ...
        {
            object obj = DbHelperSQL.GetSingle(strSql, connectionString, cmdParms);
            int cmdresult;
            if ((Object.Equals(obj, null)) || (Object.Equals(obj, System.DBNull.Value)))
            {
                cmdresult = 0;
        ...
        /// <returns>SqlDataReader</returns>
        public static SqlDataReader RunProcedure(string storedProcName, string connectionString, IDataParameter[] parameters)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
