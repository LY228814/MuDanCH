...
namespace MuDanCH.BLL
{
	...
	{
		private readonly MuDanCH.DAL.article dal=new MuDanCH.DAL.article();
		public article()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<MuDanCH.Model.article> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MuDanCH.Model.article> DataTableToList(DataTable dt)
		{
			List<MuDanCH.Model.article> modelList = new List<MuDanCH.Model.article>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MuDanCH.Model.article model;
