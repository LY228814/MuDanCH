...
namespace MuDanCH.BLL
{
	...
	{
		private readonly MuDanCH.DAL.banner dal=new MuDanCH.DAL.banner();
		public banner()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<MuDanCH.Model.banner> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MuDanCH.Model.banner> DataTableToList(DataTable dt)
		{
			List<MuDanCH.Model.banner> modelList = new List<MuDanCH.Model.banner>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MuDanCH.Model.banner model;
