...
namespace MuDanCH.BLL
{
	...
	{
		private readonly MuDanCH.DAL.news dal=new MuDanCH.DAL.news();
		public news()
		{}
		#region  BasicMethod
		...
		/// 获得数据列表
		/// </summary>
		public List<MuDanCH.Model.news> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<MuDanCH.Model.news> DataTableToList(DataTable dt)
		{
			List<MuDanCH.Model.news> modelList = new List<MuDanCH.Model.news>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				MuDanCH.Model.news model;
