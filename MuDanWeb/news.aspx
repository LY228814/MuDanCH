        ...
        <div class="wrapper wrapper-content  animated fadeInRight">
             <div class="ibox">
                    <div class="ibox-content">
                        <span class="text-muted small pull-right">最后更新：<i class="fa fa-clock-o"></i> 2021-03-25 14:26</span>
                        <h2>新闻管理</h2>
                         <div class="row">
                                        ...
                                        <div class="table-responsive">
                                             <table class="table table-striped table-hover">
                                               <thead>
                                                ...
                                                <tbody>
                                                   <asp:Repeater ID="Qnewstable" runat="server" OnItemCommand="Qnewstable_ItemCommand">
                                                        <ItemTemplate>
                                                             <tr>
                                                        ...
                                                        <td><%# Eval("author") %></td>
                                                        <td >
                                                            <asp:LinkButton ID="Ccreate" CommandArgument='<%# Eval("nid") %>' CommandName="Cupdate" runat="server">修改</asp:LinkButton>|
